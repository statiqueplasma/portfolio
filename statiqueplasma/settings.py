"""
Django settings for statiqueplasma project.
...
ROOT_URLCONF = 'statiqueplasma.urls'
...
WSGI_APPLICATION = 'statiqueplasma.wsgi.application'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'static/portfolio/img')
